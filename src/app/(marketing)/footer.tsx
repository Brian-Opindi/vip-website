          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4 relative pr-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed font-jost">
                Your personal safety companion. One tap emergency response that
                connects you to help when you need it most. Stay safe, stay
                connected.
              </p>
            ...
            <div className="space-y-4 relative px-6">
              <h3 className="text-white font-bold text-lg font-urbanist">
                Company
              </h3>
              <ul className="space-y-3">
                <li>
                  <Link
                    href="/about"
                    className="text-gray-300 hover:text-white transition-colors font-jost"
                  >
                    About
                  </Link>
                </li>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <a
                      href="tel:+1234567890"
                      className="text-gray-300 hover:text-white transition-colors font-jost flex items-center space-x-2"
                    >
                      <Phone size={16} />
        ...
        <div className="bg-white rounded-b-2xl px-8 py-2 -mx-8 -mb-10 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-700 text-xs font-urbanist">
              Copyright © Very Individual Protection Services 2025. All rights
              reserved.
            </p>
