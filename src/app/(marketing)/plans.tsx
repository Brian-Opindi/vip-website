...
const pricingPlans = [
    ...
    },
    {
        id: 'family',
        name: 'Family Plan',
        description: 'Perfect for families who want to stay connected and protected. Share locations, coordinate safety, and ensure everyone stays secure.',
        price: '$19.99',
        period: '/month',
        popular: true,
        features: [
    ...
    },
    {
        id: 'business',
        name: 'Business Plan',
        description: 'Comprehensive protection for teams and organizations. Advanced management tools, analytics, and enterprise-grade security features.',
        price: '$29.99',
        period: '/month',
        features: [
