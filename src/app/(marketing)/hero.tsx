            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="flex items-start space-x-8">
                ...
                <p className="text-lg md:text-md text-gray-300 leading-relaxed font-urbanist">
                  Wherever you are, feel safe, connected, and in control. VIP
                  alerts your trusted circle in seconds.
                </p>
              </div>
              <div className="flex flex-row gap-2 sm:gap-4 mb-10">
                <WaitlistModal>
                  <Button
                    variant="vip"
                    className="p-4 sm:p-6 font-wix-madefor-display text-sm sm:text-base"
                  >
                    <span
                      className="
