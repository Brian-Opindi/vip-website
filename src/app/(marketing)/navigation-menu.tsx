...
const learn: { title: string; href: string; description: string }[] = [
  {
    ...
    description: 'How VIP can protect you after a late-night shift',
  },
  {
    title: 'VIP for Students',
    href: '/why/vip-for-students',
    description: 'Campus safety and emergency response for students',
  },
  {
    title: 'VIP for Travelers',
    href: '/why/vip-for-travelers',
    description: 'Stay safe while exploring new places and destinations',
  },
  {
    title: 'VIP for Families',
    href: '/why/vip-for-families',
    description: 'Keep your loved ones protected with instant alerts',
  },
  {
    title: 'Emergency Response',
    href: '/learn/emergency-response',
    description: "Understanding how VIP's emergency system works",
  },
  {
    title: 'Safety Tips',
    href: '/learn/safety-tips',
    description: 'Best practices for personal safety and security',
  },
];
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-sm leading-tight text-white/80">
                            Personal safety at your fingertips. One tap
                            emergency response.
                          </p>
                        </div>
                      </Link>
