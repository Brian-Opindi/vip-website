          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Emergency activated via panic button, voice command, or
                automatic detection.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                GPS coordinates, address, and surrounding area details are
                instantly captured.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Emergency contacts, security team, and appropriate services are
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Emergency responders are dispatched while contacts coordinate
