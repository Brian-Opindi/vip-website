    ...
    const features = [
        {
            ...
            description: "Automatically shares your precise GPS coordinates with emergency contacts and responders.",
            bgColor: "bg-red-100",
        ...
        },
        {
            ...
            description: "Simultaneously notifies family, friends, security team, and emergency services.",
            bgColor: "bg-blue-100",
        ...
        },
        {
            ...
            description: "Streams live audio and video to emergency contacts for real-time situation assessment.",
        ...
        },
        {
            ...
            description: "Direct connection to 911, police, fire department, and medical emergency services.",
        ...
        },
        {
            ...
            description: "Shares critical medical information, allergies, and emergency contacts with responders.",
        ...
        },
        {
            ...
            description: "Continues monitoring and provides updates until the emergency is resolved.",
