    ...
    const features = [
        {
            ...
            description: "Share and receive instant notifications about safety concerns, suspicious activities, or emergencies in your area.",
            bgColor: "bg-vanilla",
        ...
        },
        {
            ...
            description: "Organize and coordinate neighborhood watch groups with scheduling, communication, and patrol tracking tools.",
            bgColor: "bg-teal-100",
        ...
        },
        {
            ...
            description: "Interactive community maps showing safety incidents, well-lit areas, emergency services, and safe routes.",
        ...
        },
        {
            ...
            description: "Secure messaging platform for neighbors to communicate, share information, and coordinate safety activities.",
            bgColor: "bg-blue-100",
        ...
        },
        {
            ...
            icon: "📅",
            title: "Safety Events",
            description: "Organize community safety meetings, training sessions, and emergency preparedness workshops.",
        ...
        },
        {
            ...
            description: "Acknowledge active community members and celebrate safety achievements with badges and recognition.",
