          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg font-urbanist text-gray-700 mb-6">
                Safety Communities brings neighbors together through technology
                to create a network of protection and awareness. Share real-time
                safety information, coordinate neighborhood watch activities,
                and build lasting connections with those around you.
              </p>
              <p className="text-lg font-urbanist text-gray-700 mb-6">
                From reporting suspicious activities to organizing community
                safety events, our platform empowers residents to take an active
                role in keeping their neighborhoods secure and welcoming.
              </p>
              <div className="bg-vanilla/20 border-l-4 border-coffee p-4 rounded">
                <p className="text-coffee font-urbanist font-semibold">
                  Communities using our platform report 40% fewer security
                  incidents
                </p>
              </div>
            </div>
