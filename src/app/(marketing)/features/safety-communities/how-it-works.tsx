...
const HowItWorks = () => {
    const steps = [
        {
            ...
            description: "Find and join your neighborhood community or create a new one for your area.",
            bgColor: "bg-coffee",
        ...
        },
        {
            ...
            description: "Verify your address and connect with verified neighbors in your immediate area.",
            bgColor: "bg-coffee",
            hoverBgColor: "group-hover:bg-vanilla",
            textColor: "text-white",
            hoverTextColor: "group-hover:text-coffee"
        },
        {
            ...
            description: "Share safety information, participate in discussions, and join community activities.",
            bgColor: "bg-coffee",
            hoverBgColor: "group-hover:bg-vanilla",
            textColor: "text-white",
            hoverTextColor: "group-hover:text-coffee"
        },
        {
            ...
            description: "Enjoy the benefits of a connected, safer community with ongoing support and protection.",
            bgColor: "bg-coffee",
            hoverBgColor: "group-hover:bg-vanilla",
            textColor: "text-white",
            hoverTextColor: "group-hover:text-coffee"
    ...
    const StepItem = ({ step }: { step: typeof steps[0] }) => (
        <div className="text-center group cursor-pointer">
            <div className={`w-16 h-16 ${step.bgColor} ${step.hoverBgColor} ${step.textColor} ${step.hoverTextColor} rounded-full mx-auto mb-4 flex items-center justify-center font-bold text-xl transition-all duration-500 ease-in-out group-hover:shadow-xl group-hover:shadow-coffee/30 group-hover:scale-110 group-hover:rotate-3`}>
                {step.number}
            </div>
