          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Draw virtual boundaries around important locations like home,
                school, work, or areas to avoid.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-coffee text-white rounded-full mx-auto mb-4 flex items-center justify-center font-bold text-lg">
              ...
              <p className="text-gray-600">
                Choose who gets notified and how when someone enters or leaves
                your geofenced areas.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive instant notifications and maintain peace of mind knowing
