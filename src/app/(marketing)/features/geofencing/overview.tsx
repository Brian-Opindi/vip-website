          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg font-urbanist text-gray-700 mb-6">
                Geofencing is a location-based technology that creates virtual
                boundaries around real-world geographic areas. When a device
                enters or exits these predefined zones, automated actions are
                triggered.
              </p>
              <p className="text-lg font-urbanist text-gray-700">
                For personal protection, this means instant notifications when
                family members arrive safely at school, work, or home, or alerts
                when someone ventures into potentially unsafe areas.
              </p>
            </div>
