          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg font-urbanist text-gray-700 mb-6">
                Our live tracking system provides real-time location updates
                with military-grade precision. Using advanced GPS, cellular, and
                Wi-Fi positioning, we ensure you always know where your family
                members are.
              </p>
              <p className="text-lg font-urbanist text-gray-700 mb-6">
                Whether it&apos;s monitoring children on their way to school,
                elderly parents during daily activities, or ensuring personal
                safety during travel, our live tracking keeps you connected and
                informed.
              </p>
