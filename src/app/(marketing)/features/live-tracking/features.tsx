    ...
    const features = [
        {
            ...
            description: "Get location updates every 10 seconds with pinpoint accuracy. Never lose track of what matters most.",
        ...
        },
        {
            ...
            description: "Combines GPS, cellular towers, and Wi-Fi signals for accurate positioning even indoors.",
            bgColor: "bg-blue-100",
        ...
        },
        {
            ...
            description: "View live locations on interactive maps with easy-to-use mobile and web applications.",
        ...
        },
        {
            ...
            description: "Instant panic button and automatic emergency detection with immediate location sharing.",
            bgColor: "bg-red-100",
        ...
        },
        {
            ...
            description: "Access detailed location history and movement patterns with comprehensive reporting.",
        ...
        },
        {
            ...
            description: "Smart power management ensures all-day tracking without draining device battery.",
