    ...
    return (
        <section className="max-w-6xl mx-auto">
            <div className="text-center mt-20">
                <div className="relative bg-cover bg-center bg-no-repeat rounded-3xl p-12 text-white overflow-hidden" style={{backgroundImage: 'url(/images/vip.jpg)'}}>
                    {/* Dark overlay */}
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-md font-urbanist mb-8 opacity-90 max-w-2xl mx-auto">
                            Join thousands who've already made the switch to smarter, more reliable protection.
                        </p>
                        <Button variant="vip" className="p-4 bg-white hover:bg-vanilla sm:p-6 font-wix-madefor-display text-sm sm:text-base">
                            <span
