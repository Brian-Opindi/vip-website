        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="lg:col-span-2 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-20">
              <p className="leading-relaxed font-urbanist flex-1">
                Whether you&apos;re staying safe on your own, protecting a
                child, or caring for a loved one — VIP has a plan for you.
              </p>
              <Button
                variant="vipoutline"
                className="p-6 border-coffee text-coffee font-urbanist"
              >
                <span
                  className="
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Tabs
              ...
              className="lg:col-span-3 flex flex-col lg:flex-row gap-8"
            >
                  ...
                  {pricingPlans.map(plan => (
                    ...
                    >
                      <div className="flex items-start justify-between w-full mb-3">
                        <h3 className="text-xl font-bold font-urbanist flex-1 mr-2 leading-tight">
                          {plan.name}
                        </h3>
                        {plan.popular && (
