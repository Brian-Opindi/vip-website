                ...
                <Card className="w-full max-w-lg bg-white/95 backdrop-blur-sm border-0 shadow-2xl rounded-2xl p-10">
                    <CardContent className="p-6">
                        ...
                        <p className="text-left text-xs text-gray-600 font-urbanist mb-6">
                            ...
                            <Link href="/authentication/get-started" className="text-coffee hover:text-coffee/80 font-medium">
                                Sign up
                            </Link>
                        </p>
                        ...
                        {errors.general && (
                            <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                                <p className="text-red-600 text-sm font-urbanist">{errors.general}</p>
                            </div>
                        )}
