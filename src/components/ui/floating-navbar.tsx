...
const WavyText = ({ text, isHovered, isActive }: { text: string; isHovered: boolean; isActive: boolean }) => {
    return (
...
export const FloatingNav = ({
    ...
    const handleNavClick = (idx: number, link: string, e: React.MouseEvent<HTMLAnchorElement>) => {
        e.preventDefault();
        setActiveIdx(idx);
